...
idx0 = 11
init_pwm0 = scGear.initPos[0 + idx0]
init_pwm1 = scGear.initPos[1 + idx0]
init_pwm2 = scGear.initPos[2 + idx0]
init_pwm3 = scGear.initPos[3 + idx0]
init_pwm4 = scGear.initPos[4 + idx0]
